...
export const upgrades: UpgradeDefinition[] = [
  ...
  { id: "terminal-dashboard", name: "Live terminal dashboard", description: "Adds a graphical operations dashboard as a dedicated multiplexer tab.", cost: 36, unlockAfter: 3, effect: "dashboard" },
