...
export const upgrades: UpgradeDefinition[] = [
  ...
  { id: "terminal-dashboard", name: "Live terminal dashboard", description: "Adds a graphical operations dashboard as an optional multiplexer pane.", cost: 36, unlockAfter: 3, effect: "dashboard" },
